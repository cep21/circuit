...
func TestRollingCounter_MoveForward(t *testing.T) {
	...
	if x.RollingSum(moveCloseToEnd) != 4 {
	...
	if x.RollingSum(movePastAllButOneBucket) != 2 {
	...
	if s := x.RollingSum(movePastAllBuckets); s != 1 {
